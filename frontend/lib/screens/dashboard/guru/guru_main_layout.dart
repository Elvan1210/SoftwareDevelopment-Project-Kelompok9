          ...
          child: Container(
            ...
            child: NavigationBar(
              ...
              destinations: const [
                ...
                NavigationDestination(icon: Icon(Icons.how_to_reg_outlined), selectedIcon: Icon(Icons.how_to_reg), label: 'Presensi'),
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth > 900) { // Bumped breakpoint slightly for the wider UI
