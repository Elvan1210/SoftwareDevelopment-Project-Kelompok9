  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text(
          'Masukkan email kamu dan kami akan mengirimkan kode verifikasi OTP.',
          style: GoogleFonts.inter(
            fontSize: 16,
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText: 'nama@pskd.sch.id',
                hintStyle: GoogleFonts.inter(color: _onSurfaceVariant.withAlpha(150), fontSize: 16),
                suffixIcon: const Icon(Icons.mail_outline_rounded, color: _onSurfaceVariant),
                filled: true,
                  ...
                  child: Center(
                    child: _isLoading 
                      ...
                      : Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Kirim Kode Verifikasi', style: GoogleFonts.plusJakartaSans(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white)),
